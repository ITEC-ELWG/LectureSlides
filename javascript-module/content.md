...
*当模块过于庞大时，对其进行分解并形成新的小模块文件是很自然的事情。*

***问题依旧存在：每个人都可能按照自己的方式编写模块；模块依赖变得错综复杂时，很难维护***
...
* 模块是**松散耦合的**，**实现特定功能的**一组方法的集合。
* 使用模块是为了解决**恼人的命名冲突**和**繁琐的文件依赖**，并且能够让你更好地**组织代码和逻辑**
* 抛开模块化，你学到（复习）了以下JS的基本知识：对象字面量、对象的扩展、作用域、立即函数、闭包
* 可以用原生的Javascript特性（主要是闭包）来编写Javascript模块
* CommonJS和AMD模块规范
* Require.js和Sea.js
---
...
* 阮一峰的[《Javascript模块化编程》](http://www.ruanyifeng.com/blog/2012/10/javascript_module.html)系列（共3篇）
